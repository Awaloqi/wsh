  ...
  return (
    <footer>
      <div className="badge-container">
        ...
        <div className="badge-main">
          <img className="badgeimageMain" src={FastDelivery} alt="FastDelivery" />
        ...
        <div className="badge-main">
          <img className="badgeimageMain" src={UnmatchedPricesandServices} alt="UnmatchedPricesandServices" />
