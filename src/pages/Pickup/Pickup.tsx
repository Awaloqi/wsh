          ...
          <p style={{ margin: '4% 0%', fontSize: '12px' }} className={styles.hideOnMobile}>
            {isRush ? (
              <>
                ...
                stains present) rush service may not be ideal as more time may be necessary to process the order. If any
              ...
              <>
                ...
                items with more than usual or complex stains. Also, if you&apos;re including Alterations please allow
                time to process. If any questions email <a href="mailto:cs@washmix.com">cs@washmix.com</a>
              </>
            )}
          </p>
          <Button
