        ...
        <div className="content-container d-flex flex-wrap">
          <div className="col-12 col-sm-12 col-md-6 washmix-container d-flex flex-column justify-content-center">
            ...
            <p className="paragraph_main mt-2">
              Purchase the desired credit, put toward any desired service and get the exclusive disounts and ton of
              perks
            </p>
          </div>
              ...
              <SingleFAQ
                ...
                answer={
                  <p>
                    ...
                    to a Gift Card. You can use it to pay for services, and while getting everything at a discounted
                    rate.
                  </p>
                }
              />
