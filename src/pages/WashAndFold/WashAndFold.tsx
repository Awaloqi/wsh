      ...
      <div className="how-it-works content-container d-flex flex-column align-items-center">
        ...
        <div className="d-flex flex-column flex-lg-row">
          <div className="d-flex flex-column align-items-center col-12 col-lg-4">
            ...
            <p className="small-text">
              {'Sign up & Schedule a pickup from your'} <span style={{ fontWeight: 'bold' }}>HOME or OFFICE.</span> You
              are <span style={{ fontWeight: 'bold' }}>NOT</span> required to be present.{' '}
        ...
        <div className="vs-block d-flex flex-column flex-lg-row mt-0 mt-md-5 content-container">
          <div className="col-12 col-lg-6 d-flex flex-column text-left align-items-center justify-content-center">
            ...
            <p className="mt-4 description">
              ...
              individually processed, cleaned and <b>PRESSED</b> and are individually charged (i.e. 1 Laundry Shirt) vs.
              <b>Wash & Fold</b> are folded (<b>NOT</b> pressed).
            </p>
            <div className="w-100">
              <SingleFAQ
                fullWidth={true}
        ...
        <SingleFAQ
          ...
          answer={
            <ul>
              ...
              <li>
                We recommend sending your delicate items [i.e. Cashmere Sweaters, Silk, and other similar items] through
                Laundry and Dry Cleaning, which will undergo different processes and are individually processed and
                charged. <b>Rule of thumb:</b> Wash & Folds are for typical items that you’d clean with Washer and dry
                with a dryer machine.
              </li>
            </ul>
          }
        />
