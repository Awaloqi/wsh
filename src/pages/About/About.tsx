        ...
        <div className={styles.paddedAboutUs}>
          ...
          <div>
            ...
            <p className={styles.paddedText}>
              ...
              <br />
              <br />
              Here at WashMix, we operate our own processing plant equipped with state of the art machinery that is
              green and environmentally friendly. We do NOT operate any Perchlorethylene (PERC) which is a common
              chemical used in the industry and by some establishments.
              <br />
              <br />
              Our commitment being Green starts with out 100% Perc-FREE dry cleaning process. The State-of-the-art Union
              dry cleaning machines allow for not only more precision and quality, but also a greener clean in lesstime,
