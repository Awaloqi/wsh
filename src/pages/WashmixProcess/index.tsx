        ...
        <div className="col-12 d-flex flex-wrap justify-content-center align-items-center">
          <div className="col-12 col-sm-6">
            ...
            <p style={{ color: '#757575' }} className="bg_color_para">
              Mauris vitae ex egestas, volutpat orci fermentum, mattis tortor. Donec libero dui, rhoncus nec iaculis ut,
              consequat quis lectus. Morbi tincidunt ligula eget luctus sagittis. Suspendisse a mi vel ligula vulputate
              egestas.
            </p>
          </div>
          <div className="col-12 col-sm-6 p-3 p-md-5">
